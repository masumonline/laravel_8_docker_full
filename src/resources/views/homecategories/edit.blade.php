  ...
  <div class="p-4 bg-white block sm:flex items-center justify-between border-b border-gray-200 lg:mt-1.5">
    <div class="mb-1 w-full">
      <div class="mb-4">
        ...
        <h1 class="text-xl sm:text-2xl font-semibold text-gray-900">Edit Home Categorys</h1>
      </div>
    </div>
  </div>
    ...
    <div class="overflow-x-auto">
      <div class="align-middle inline-block min-w-full">
        <div class="shadow overflow-hidden">
          <form method="post" action="{{route('homecategorys.update', $homecategory->id)}}">
            @csrf
            {{ method_field('PUT') }}
            <table class="table-fixed min-w-full divide-y divide-gray-200">
              <tbody class="bg-white divide-y divide-gray-200">
                <tr class="hover:bg-gray-100">
                  ...
                  <td class="p-4 whitespace-nowrap text-sm font-normal text-gray-500">
                    <div class="text-base font-semibold text-gray-900">
                      <input type="text" name="name" id="name" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-cyan-600 focus:border-cyan-600 block w-full p-2.5" placeholder="Box Name" value="{{$homecategory->name}}">
                    </div>
                  </td>
                </tr>
                <tr class="hover:bg-gray-100">
                ...
                <tr class="hover:bg-gray-100">
                  ...
                  <td class="p-4 whitespace-nowrap text-sm font-normal text-gray-500">
                    <div class="text-base font-semibold text-gray-900">
                      <input type="number" name="sort" id="sort" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-cyan-600 focus:border-cyan-600 block w-full p-2.5" placeholder="Sort" value="{{$homecategory->sort}}">
                    </div>
                  </td>
                </tr>
                <tr class="hover:bg-gray-100">
                  ...
                  <td class="p-4 whitespace-nowrap text-sm font-normal text-gray-500">
                    <div class="text-base font-semibold text-gray-900">
                    <img class="w-64" src="{{$homecategory->image}}">
                      <div class="flex w-full items-center justify-left bg-grey-lighter">
                        <label id="lfm" data-input="thumbnail" data-preview="holder" class="w-64 flex flex-col items-center px-4 py-6 bg-white text-blue rounded-lg shadow-lg tracking-wide uppercase border border-blue cursor-pointer hover:bg-blue-600 hover:text-white">
                          ...
                          <input id="thumbnail" class="hidden" type="text" name="image" value="{{$homecategory->image}}">
                        </label>
                      </div>
                    </div>
                  </td>
                ...
                <tr class="hover:bg-gray-100">
                  ...
                  <td class="p-4 whitespace-nowrap text-sm font-normal text-gray-500">
                    <div class="text-base font-semibold text-gray-900">
                      <input type="text" name="url" id="url" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-cyan-600 focus:border-cyan-600 block w-full p-2.5" placeholder="URL" value="{{$homecategory->url}}">
                    </div>
                  </td>
                </tr>
                <tr>
