          ...
          <table class="table-fixed min-w-full divide-y divide-gray-200">
            <tbody class="bg-gray-100">
              ...
              <tr class="hover:bg-gray-100">
                ...
                <td class="p-4 w-6">{{ $page->slug }}</td>
              </tr>
              <tr class="hover:bg-gray-100">
                <td class="p-4 w-2">Details</td>
                <td class="p-4 w-6">{!! $page->details !!}</td>
              </tr>
              <tr class="hover:bg-gray-100">
                <td class="p-4 w-2">Meta Tag</td>
                <td class="p-4 w-6">{{ $page->meta_tag }}</td>
              </tr>
              <tr class="hover:bg-gray-100">
                <td class="p-4 w-2">Meta Description</td>
                <td class="p-4 w-6">{{ $page->meta_description }}</td>
              </tr>
              <tr class="hover:bg-gray-100">
                <td class="p-4 w-2">Header</td>
                <td class="p-4 w-6">{{ $page->header }}</td>
              </tr>
              <tr class="hover:bg-gray-100">
                <td class="p-4 w-2">Footer</td>
                <td class="p-4 w-6">{{ $page->footer}}</td>
              </tr>
            </tbody>
          </table>
        </div>
