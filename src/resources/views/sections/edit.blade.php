  ...
  <div class="p-4 bg-white block sm:flex items-center justify-between border-b border-gray-200 lg:mt-1.5">
    <div class="mb-1 w-full">
      <div class="mb-4">
          ...
          <ol class="inline-flex items-center space-x-1 md:space-x-2">
            ...
            <li>
              <div class="flex items-center">
                ...
                <a href="/sections" class="text-gray-700 hover:text-gray-900 ml-1 md:ml-2 text-sm font-medium">Section</a>
              </div>
            </li>
            <li>
              <div class="flex items-center">
        ...
        <h1 class="text-xl sm:text-2xl font-semibold text-gray-900">Edit Section</h1>
      </div>
    </div>
  </div>
            ...
            <table class="table-fixed min-w-full divide-y divide-gray-200">
              <tbody class="bg-white divide-y divide-gray-200">
                <tr class="hover:bg-gray-100">
                  ...
                  <td class="p-4 whitespace-nowrap text-sm font-normal text-gray-500">
                    <div class="text-base font-semibold text-gray-900">
                      <input type="text" name="name" id="name" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-cyan-600 focus:border-cyan-600 block w-full p-2.5" placeholder="Box Name" value="{{$section->name}}">
                    </div>
                  </td>
                </tr>
                <tr class="hover:bg-gray-100">
                ...
                <tr class="hover:bg-gray-100">
                  ...
                  <td class="p-4 whitespace-nowrap text-sm font-normal text-gray-500">
                    <div class="text-base font-semibold text-gray-900">
                      <input type="number" name="sort" id="sort" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-cyan-600 focus:border-cyan-600 block w-full p-2.5" placeholder="Box sort" value="{{$section->sort}}">
                    </div>
                  </td>
                </tr>
                <tr class="hover:bg-gray-100">
                  ...
                  <td class="p-4 whitespace-nowrap text-sm font-normal text-gray-500">
                    <div class="text-base font-semibold text-gray-900">
                      <img class="w-64" src="{{$section->image}}">
                      <div class="flex w-full items-center justify-left bg-grey-lighter">
                        <label id="lfm" data-input="thumbnail" data-preview="holder" class="w-64 flex flex-col items-center px-4 py-6 bg-white text-blue rounded-lg shadow-lg tracking-wide uppercase border border-blue cursor-pointer hover:bg-blue-600 hover:text-white">
                          ...
                          <input id="thumbnail" class="hidden" type="text" name="image" value="{{$section->image}}">
                        </label>
                      </div>
                    </div>
                  </td>
                ...
                <tr class="hover:bg-gray-100">
                  ...
                  <td class="p-4 whitespace-nowrap text-sm font-normal text-gray-500">
                    <div class="text-base font-semibold text-gray-900">
                      <input type="text" name="url" id="url" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-cyan-600 focus:border-cyan-600 block w-full p-2.5" placeholder="Url" value="{{$section->url}}">
                    </div>
                  </td>
                </tr>
                <tr>
