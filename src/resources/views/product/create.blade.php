  ...
  <div class="p-4 bg-white block sm:flex items-center justify-between border-b border-gray-200 lg:mt-1.5">
    <div class="mb-1 w-full">
      <div class="mb-4">
        ...
        <h1 class="text-xl sm:text-2xl font-semibold text-gray-900">Create products</h1>
      </div>
    </div>
  </div>
            ...
            <table class="table-fixed min-w-full divide-y divide-gray-200">
              <tbody class="bg-gray-100">
                <tr class="hover:bg-gray-100">
                  ...
                  <td class="p-4 w-4">
                    <input type="text" name="name" id="name" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-cyan-600 focus:border-cyan-600 block w-full p-2.5" placeholder="Name" required="" value="{{old('name')}}">
                  </td>
                </tr>
                <tr class="hover:bg-gray-100">
                  <td class="p-4 w-4">Sku</td>
                  <td class="p-4 w-4">
                    <input type="text" name="sku" id="sku" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-cyan-600 focus:border-cyan-600 block w-full p-2.5" placeholder="SKU" required="" value="{{old('sku')}}">
                  </td>
                </tr>
                <tr class="hover:bg-gray-100">
                ...
                <tr class="hover:bg-gray-100">
                  ...
                  <td class="p-4 w-4">
                    <input type="text" name="model" id="model" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-cyan-600 focus:border-cyan-600 block w-full p-2.5" placeholder="Model" required="" value="{{old('model')}}">
                  </td>
                </tr>
                <tr class="hover:bg-gray-100">
                ...
                <tr class="hover:bg-gray-100">
                  ...
                  <td class="p-4 w-4">
                    <input type="text" name="tags" id="tags" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-cyan-600 focus:border-cyan-600 block w-full p-2.5" placeholder="Ex: tag1, tag2, tag3" value="{{old('tag')}}">
                  </td>
                </tr>
                <tr class="hover:bg-gray-100">
                  <td class="p-4 w-4">Features</td>
                  <td class="p-4 w-4">
                    <input type="text" name="features" id="features" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-cyan-600 focus:border-cyan-600 block w-full p-2.5" placeholder="Features" value="{{old('features')}}">
                  </td>
                </tr>
                <tr class="hover:bg-gray-100">
                  <td class="p-4 w-4">SEO Meta Tag</td>
                  <td class="p-4 w-4">
                    <input type="text" name="meta_tag" id="meta_tag" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-cyan-600 focus:border-cyan-600 block w-full p-2.5" placeholder="Meta Tag" value="{{old('meta_tag')}}">
                  </td>
                </tr>
                <tr class="hover:bg-gray-100">
                  <td class="p-4 w-4">SEO Meta Description</td>
                  <td class="p-4 w-4">
                    <input type="text" name="meta_description" id="meta_description" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-cyan-600 focus:border-cyan-600 block w-full p-2.5" placeholder="Meta Description" value="{{old('meta_description')}}">
                  </td>
                </tr>
                <tr class="hover:bg-gray-100">
                  <td class="p-4 w-4">Youtube</td>
                  <td class="p-4 w-4">
                    <input type="text" name="youtube" id="youtube" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-cyan-600 focus:border-cyan-600 block w-full p-2.5" placeholder="Youtube Link" value="{{old('youtube')}}">
                  </td>
