                ...
                <tr class="hover:bg-gray-100">
                  ...
                  <td class="p-4 whitespace-nowrap text-sm font-normal text-gray-500">
                    <div class="text-base font-semibold text-gray-900">
                      <input type="text" name="name" id="name" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-cyan-600 focus:border-cyan-600 block w-full p-2.5" placeholder="name" value="{{$slider->name}}">
                    </div>
                  </td>
                </tr>
                <tr class="hover:bg-gray-100">
                  ...
                  <td class="p-4 whitespace-nowrap text-sm font-normal text-gray-500">
                    <div class="text-base font-semibold text-gray-900">
                    <input type="number" name="sort" id="sort" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-cyan-600 focus:border-cyan-600 block w-full p-2.5" placeholder="0" value="{{$slider->sort}}">
                    </div>
                  </td>
                </tr>
                <tr class="hover:bg-gray-100">
                  ...
                  <td class="p-4 whitespace-nowrap text-sm font-normal text-gray-500">
                    <div class="text-base font-semibold text-gray-900">
                    <input type="text" name="url" id="url" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-cyan-600 focus:border-cyan-600 block w-full p-2.5" placeholder="0" value="{{$slider->url}}">
                    </div>
                  </td>
                </tr>
                <tr class="hover:bg-gray-100">
                  ...
                  <td class="p-4 whitespace-nowrap text-sm font-normal text-gray-500">
                    <img class="w-64" src="{{$slider->image}}">
                    <div class="flex w-full items-center justify-left bg-grey-lighter">
                      <label id="lfm" data-input="thumbnail" data-preview="holder" class="w-64 flex flex-col items-center px-4 py-6 bg-white text-blue rounded-lg shadow-lg tracking-wide uppercase border border-blue cursor-pointer hover:bg-blue-600 hover:text-white">
                        ...
                        <input id="thumbnail" class="hidden" type="text" name="image" value="{{$slider->image}}">
                      </label>
                    </div>
                  </td>
                </tr>
